<?php //session_start();
    if($_POST){
        include('Tech.php');
        $user_object=new Tech();
        $loggedinuser=$user_object->login($_POST['email'],$_POST['pwd']);
        if(!$loggedinuser){
           $report= "<div class='alert alert-danger'>Invalid Login. Please retry</div>";
        }else{
            $_SESSION['email']=$loggedinuser['email'];
            $_SESSION['lastname']=$loggedinuser['lname'];
            $_SESSION['firstname']=$loggedinuser['fname'];
            $_SESSION['custid']=$loggedinuser['id'];
            header("Location: tech_profile.php?msg=Successfully logged in");
        }
    }
?>
      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
          <ul class="navbar-nav me-auto ml-5 mb-2 mb-lg-0">
            ...
            <li class="nav-item">
              <a class="nav-link nav-color px-4 disabled" href="#">Support</a>
            </li>
    ...
    <div class="container-fluid mx-0 px-0">
      <div class="row">
        ...
        <div class="col-6 nav-bg   ">
          <h4 class="display-4 text-light ml-5 text-center mt-4">Repair & earn with</h4><h3 class="display-4 mt-2 mb-5 ml-5 text-center text-light font-weight-bolder">AUTO-CARE.</h3>

            <br><br>
             <form action="tech_logsubmit.php" class="text-center" method="POST" >
            ...
            <input type="password" name="pwd" class="col col-md-6 mb-3 form-control border-primary mx-auto " id="" value="" placeholder="password" required="">

            
              
            <button type="submit" id="signin" class="mb-2 col-md-6 col btn text-light " >Login</button>
            <p class="text-center text-white">Don't have an account? Please <a href="tech_signup.php">Signup</a></p>
