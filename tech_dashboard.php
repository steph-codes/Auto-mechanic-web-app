	...
	<!--nav-->
		...
		<div class="container-fluid ">
			<div class="row h-100">
				...
				<div class=" col-10">
				<h1 class="text-center font-weight-lighter my-5">Available Orders</h1> 
                ...
                <table class="table ml-0 table-striped border-bottom mt-5 table-hover">
                    ...
                    <?php
						...
						<th class='px-0 mx-0 border-left'>ORDER-ID</th>
						<th class='px-3'>CUSTOMER</th>
						<th class='px-5'>PHONE</th>
						<th class='px-5'>DATE</th>
						<th class='px-5'>ADDRESS</th>
						<th class='px-5'>DETAILS</th>
						<th class='text-secondary'>cancel</th>
						<th class='border-right text-secondary mr-2'>cancel</th>
						
						</tr>";
                        foreach($col as $k=>$val){
                        ?>
						<td class="px-5 border-left"><?php echo $val['order_id']?></td>
                        <td class="px-0"><?php echo $val['customer_fname']." ". $val['customer_lname']; ?></td>
